            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    if (f_item.isFormField()) {
                        ...
                        value[k] = f_item.getString();//weaver typing value
                ...
                if (value[7].equals(value[6])) {//Strinh str1="insert into tbl_weaver ()";//inserting file
                    String InsQry = "INSERT INTO `tbl_weaver`( `weaver_name`, `weaver_contact`, `weaver_email`,`weaver_address`,place_id, `weaver_photo`,`weaver_proof`,`weaver_password`)"
