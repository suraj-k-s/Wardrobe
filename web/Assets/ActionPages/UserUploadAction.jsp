...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                if (value[7].equals(value[8])) {//Strinh str1="insert into tbl_user ()";//inserting file
                    String InsQry = "INSERT INTO tbl_user( `user_name`, `user_contact`, `user_email`,`user_address`,place_id, `user_photo`,`user_proof`,user_doj,`user_password`)"
                            + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[6] + "','" + photo + "','" + proof + "',curdate(),'" + value[7] + "')";
