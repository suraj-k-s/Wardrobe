...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        String InsQry = "INSERT INTO `tbl_product`(product_name,product_details,product_photo,product_rate,weaver_id)"
                + "values('" + value[0] + "','" + value[1] + "','" + photo + "','" + value[2] + "','"+session.getAttribute("wid")+"')";
