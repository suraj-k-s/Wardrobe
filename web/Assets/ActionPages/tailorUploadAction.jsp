            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    if (f_item.isFormField()) {
                        ...
                        value[k] = f_item.getString();//tailor typing value
                ...
                if (value[7].equals(value[6])) {//Strinh str1="insert into tbl_tailor ()";//inserting file
                    String InsQry = "INSERT INTO `tbl_tailor`( `tailor_name`, `tailor_contact`, `tailor_email`,`tailor_address`,place_id, `tailor_photo`,`tailor_proof`,`tailor_password`)"
