...
<html lang="en" >
    ...
    <%        if (request.getParameter("aid") != null) {
            ...
            String upQry = "update tbl_tailor set tailor_status='1' where tailor_id='" + request.getParameter("aid") + "'";
        ...
        if (request.getParameter("rid") != null) {
            ...
            String upQry = "update tbl_tailor set tailor_status='2' where tailor_id='" + request.getParameter("rid") + "'";
            if (con.executeCommand(upQry)) {
    ...
    %>
    <body>
        <h1 align="center" id="heading">tailor Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_tailor c inner join tbl_place p on p.place_id=c.place_id inner join tbl_district d on d.district_id=p.district_id where tailor_status='0'";
                ...
                <tr>
                    <td><%=i%></td>
                    <td><%=rs.getString("tailor_name")%></td>
                    <td><%=rs.getString("district_name")%></td>
                    <td><%=rs.getString("place_name")%></td>
                    <td><%=rs.getString("tailor_contact")%></td>
                    <td><%=rs.getString("tailor_email")%></td>
                    <td align="center">
                        <a href="NewShop.jsp?aid=<%=rs.getString("tailor_id")%>"><img src="../Assets/Template/admin/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="NewShop.jsp?rid=<%=rs.getString("tailor_id")%>"><img src="../Assets/Template/admin/remove.png"  width="25" height="25"></a>
                    </td>
                </tr>
                <%
                    }
