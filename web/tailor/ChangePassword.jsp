    ...
    <body>
        ...
        <%
            if (request.getParameter("btn_submit") != null) {
                ...
                rsd.next();
                if (cp.equals(rsd.getString("weaver_password"))) {
                    if (np.equals(rsd.getString("weaver_password"))) {
        %>
        <script>
        ...
        <%
            ...
            if (np.equals(rp)) {
                String upQry = "update tbl_weaver set weaver_password='" + np + "' where weaver_id='" + session.getAttribute("wid") + "'";
