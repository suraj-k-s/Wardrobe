                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="contact-form">
                            <form enctype="multipart/form-data" method="post" action="../Assets/ActionPages/WProductUploadAction.jsp">
                                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="contact-form" id="tab">
                            <table>
                                ...
                                <%
                                    int i = 0;
                                    String selQryP = "select * from tbl_product where weaver_id='" + session.getAttribute("wid") + "'";
