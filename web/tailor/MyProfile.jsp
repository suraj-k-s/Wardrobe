                            ...
                            <form  method="post" >
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <img src="../Assets/Files/<%=rs.getString("weaver_photo")%>" width="150" height="120" style="border-radius: 50%">
                                    </div>
                                    <div class="col-lg-12">
                                      Name :  <%=rs.getString("weaver_name")%>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                     Contact :   <%=rs.getString("weaver_contact")%>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                     Email :   <%=rs.getString("weaver_email")%>
                                    </div>
                                    <div class="col-lg-12">
                                        <fieldset>
