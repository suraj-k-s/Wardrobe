    ...
    <body>
        ...
        <%
            if (request.getParameter("btn_submit") != null) {
                ...
                rsd.next();
                if (cp.equals(rsd.getString("tailor_password"))) {
                    if (np.equals(rsd.getString("tailor_password"))) {
        %>
        <script>
        ...
        <%
            ...
            if (np.equals(rp)) {
                String upQry = "update tbl_tailor set tailor_password='" + np + "' where tailor_id='" + session.getAttribute("tid") + "'";
